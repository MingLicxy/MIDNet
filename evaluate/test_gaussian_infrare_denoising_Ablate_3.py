...
#TODO 改动点一
from basicsr.models.archs.Ablate_Difformer_3_arch import Ablate_Difformer_3
...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/Ablate_3', type=str, help='Directory for results')
...
#TODO 改动点三
opt_str = r"""
  type: Ablate_Difformer_3   # 单输入单输出
  inp_channels: 1
  out_channels: 1
  dim: 48
  num_blocks: [2, 4, 4]
...
#TODO 改动点四： 创建模型
model_restoration = Ablate_Difformer_3(**opt)    
...
if sigma == 15:
    ...
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/Ablate_DFormerSigma50_3/models/net_g_260000.pth'
