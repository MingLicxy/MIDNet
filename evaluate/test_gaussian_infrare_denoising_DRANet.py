...
#TODO 改动点一
from basicsr.models.archs.DRANet_arch import DRANet
...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/DRANet', type=str, help='Directory for results')
...
#TODO 改动点三
opt_str = r"""
  type: DRANet   # 注意：Difformer不是文件名是类名
  in_nc: 1
  out_nc: 1
  nc: 128
  # nb: 4
...
#TODO 改动点四： 创建模型
model_restoration = DRANet(**opt)    

#TODO 改动点五： 加载权重
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DRANetSigma15/models/net_g_latest.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DRANetSigma25/models/net_g_latest.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DRANetSigma50/models/net_g_latest.pth'
