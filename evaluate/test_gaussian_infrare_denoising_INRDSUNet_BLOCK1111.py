...
#TODO 改动点一
from basicsr.models.archs.INRDSUNet_arch import INRDSUNet
...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/INRDSUNet_BLOCK1111', type=str, help='Directory for results')
...
#TODO 改动点三
opt_str = r"""
  type: INRDSUNet   # 注意：Difformer不是文件名是类名
  inp_channels: 1
  out_channels: 1
  dim: 48
  num_blocks: [1,1,1,1]   # [2,4,4,6]
...
#TODO 改动点四： 创建模型
model_restoration = INRDSUNet(**opt)    

#TODO 改动点五： 加载权重
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma15_SINE/models/net_g_292000.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma25_SINE/models/net_g_300000.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma50_BLOCK1111/models/net_g_200000.pth'
