...
from basicsr.models.archs.IDTransformer_arch import IDTransformer
...
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/IDTransformer', type=str, help='Directory for results')
...
#TODO 模型参数与训练阶段保持不变
opt_str = r"""
  type: IDTransformer   # 注意：Difformer不是文件名是类名
  inp_channels: 1
  out_channels: 1
  dim: 48
...
# 创建模型
model_restoration = IDTransformer(**opt)    

# 加载权重
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_IDTransformerSigma15/models/net_g_latest.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_IDTransformerSigma25/models/net_g_latest.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_IDTransformerSigma50/models/net_g_latest.pth'
