...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/INRDSUNet_SINE', type=str, help='Directory for results')
...
opt_str = r"""
  ...
  inr_act: 'sine'  # 'relu', 'gelu', 'sine', 'expsin', 'gaussian', 'quadratic', 'multi_quadratic', 'laplacian', 'super_gaussian'
...
if sigma == 15:
    ...
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma50_ReLU/models/net_g_296000.pth'
