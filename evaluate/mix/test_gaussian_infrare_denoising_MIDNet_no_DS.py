...
parser.add_argument('--result_dir', default='/home/caoxinyu/Xformer-main/results/MIDNet_no_DS_mix', type=str, help='Directory for results')
...
if level == 1:
    ...
    weights = '/home/caoxinyu/Xformer-main/experiments/GaussianGrayDenoising_MIDNetNetSigmaMix_no_DS/models/net_g_264000.pth'
