...
from basicsr.models.archs.MIDNet_conv_arch import INRDSUNet_Conv
...
parser.add_argument('--result_dir', default='/home/caoxinyu/Xformer-main/results/MIDNet_Conv', type=str, help='Directory for results')
...
#TODO 改动点三
opt_str = r"""
  type: INRDSUNet_Conv   # 注意：Difformer不是文件名是类名
  inp_channels: 1
  out_channels: 1
  dim: 48
...
# 创建模型
model_restoration = INRDSUNet_Conv(**opt)    
...
if level == 1:
    ...
    weights = '/home/caoxinyu/Xformer-main/experiments/GaussianGrayDenoising_MIDNetMixLevel2Conv/models/net_g_264000.pth'
