...
#TODO 决定加入噪声强度
parser.add_argument('--levels', default='2', type=str, help='Noise levels')

args = parser.parse_args()

levels = np.int_(args.levels.split(',')) # [1,2]
...
for dataset in datasets:
    ...
    gt_path = os.path.join('/home/caoxinyu/infrare_data/test', dataset)
    ...
    for level_test in levels:
        ...
        file_path = os.path.join('/home/caoxinyu/Xformer-main/results/MIDNet_DWConv', dataset, str(level_test))
