...
#TODO 改动点一
from basicsr.models.archs.INRSwinUNet_arch import INRSwinUNet
...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/INRDSUNet_no_DS', type=str, help='Directory for results')
...
#TODO 改动点四： 创建模型
model_restoration = INRSwinUNet(**opt)    
...
if sigma == 15:
    ...
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma50_no_DS/models/net_g_224000.pth'
