...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/INRDSUNet_INR111', type=str, help='Directory for results')
...
opt_str = r"""
  ...
  inr_hidden_list: [[256], [256], [256]]  # Hidden layer sizes for INR
"""
...
if sigma == 15:
    ...
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma50_INR111/models/net_g_200000.pth'
