...
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/Difformer', type=str, help='Directory for results')
...
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DFormerSigma15/models/net_g_292000.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DFormerSigma25/models/net_g_280000.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DFormerSigma50_1/models/net_g_276000.pth'
