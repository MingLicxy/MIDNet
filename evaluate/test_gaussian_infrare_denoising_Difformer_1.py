...
from basicsr.models.archs.Difformer_qkv_arch import Difformer
...
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/Difformer_1', type=str, help='Directory for results')
...
# 创建模型
model_restoration = Difformer(**opt)    

# 加载权重
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DFormerSigma15_1/models/net_g_268000.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DFormerSigma25_1/models/net_g_300000.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DFormerSigma50_1/models/net_g_292000.pth'
