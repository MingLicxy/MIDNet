...
from basicsr.models.archs.DnCNN_arch import DnCNN
...
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/DnCNN', type=str, help='Directory for results')
...
#TODO 模型参数与训练阶段保持不变
opt_str = r"""
  type: DnCNN   # 注意：Difformer不是文件名是类名
  in_nc: 1
  out_nc: 1
  nc: 64
  nb: 17
...
# 创建模型
model_restoration = DnCNN(**opt)    

# 加载权重
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DnCNNSigma15/models/net_g_288000.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DnCNNSigma25/models/net_g_260000.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DnCNNSigma50/models/net_g_260000.pth'
