...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/INRDSUNet_Quadratic', type=str, help='Directory for results')
...
opt_str = r"""
  ...
  inr_act: 'quadratic'  # 'relu', 'gelu', 'sine', 'expsin', 'gaussian', 'quadratic', 'multi_quadratic', 'laplacian', 'super_gaussian'
...
if sigma == 15:
    ...
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma50_Quadratic/models/net_g_232000.pth'
