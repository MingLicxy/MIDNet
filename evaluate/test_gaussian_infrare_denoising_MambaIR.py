...
#TODO 改动点一
from basicsr.models.archs.mambair_arch import MambaIR
...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/MambaIR', type=str, help='Directory for results')
...
#TODO 改动点四： 创建模型
model_restoration = MambaIR(**opt)    

#TODO 改动点五： 加载权重
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_MambaIRSigma15/models/net_g_300000.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_MambaIRSigma25/models/net_g_300000.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_MambaIRSigma50/models/net_g_224000.pth'
