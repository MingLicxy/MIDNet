...
from basicsr.models.archs.DRUNet_arch import DRUNet
...
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/DRUNet', type=str, help='Directory for results')
...
#TODO 模型参数与训练阶段保持不变
opt_str = r"""
  type: DRUNet   # 注意：Difformer不是文件名是类名
  in_nc: 1
  out_nc: 1
  nc: [64, 128, 256, 512]
  nb: 4
...
# 创建模型
model_restoration = DRUNet(**opt)    

# 加载权重
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DRUNetSigma15/models/net_g_292000.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DRUNetSigma25/models/net_g_296000.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DRUNetSigma50/models/net_g_292000.pth'
