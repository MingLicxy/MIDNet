...
#TODO 改动点一
from basicsr.models.archs.Uformer_arch import Uformer
...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/Uformer', type=str, help='Directory for results')
...
#TODO 改动点三
opt_str = r"""
  type: Uformer   # 注意：Difformer不是文件名是类名
  in_chans: 1
  dim: 32
  depths: [2, 2, 2, 2, 2, 2, 2, 2, 2]   # B:[1, 2, 8, 8, 8, 8, 8, 2, 1]
...
#TODO 改动点四： 创建模型
model_restoration = Uformer(**opt)    

#TODO 改动点五： 加载权重
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_UFormerSigma15/models/net_g_latest.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_UFormerSigma25/models/net_g_latest.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_UFormerSigma50/models/net_g_latest.pth'
