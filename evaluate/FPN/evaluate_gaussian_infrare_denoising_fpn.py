...
#TODO 决定加入噪声强度
parser.add_argument('--levels', default='1,2', type=str, help='Noise levels')
...
for dataset in datasets:
    ...
    for level_test in levels:
        ...
        file_path = os.path.join('/home/caoxinyu/UNet-based/Xformer-main/results/SwinIR', dataset, str(level_test))
