...
# Xformer 主目录
project_dir = os.path.expanduser('~/UNet-based/Xformer-main')
...
if level == 1:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_MambaIRFPNLevel1/models/net_g_latest.pth'
elif level == 2:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_MambaIRFPNLevel2/models/net_g_latest.pth'
