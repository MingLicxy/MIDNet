...
if level == 1:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DRUNetFPNLevel1/models/net_g_latest.pth'
elif level == 2:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_DRUNetFPNLevel2/models/net_g_latest.pth'
