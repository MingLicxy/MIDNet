...
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/', type=str, help='Directory for results')
...
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_XFormerSigma15/models/net_g_300000.pth'
elif sigma == 25:
...
for dataset in datasets:
    ...
    # 输出图像路径: '/home/caoxinyu/UNet-based/Xformer-main/results/DLS-NUC-100/15'
    ...
    with torch.no_grad():
        for file_ in tqdm(files):
            ...
            ################################## TODO 注意Oformer返回的数组 ##################################
            restoreds = model_restoration(input_)
            restored = restoreds[0]
