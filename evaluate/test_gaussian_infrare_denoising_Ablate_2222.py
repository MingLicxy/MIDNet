...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/Ablate_2222', type=str, help='Directory for results')
...
#TODO 改动点三
opt_str = r"""
  type: Difformer   # 单输入单输出
  inp_channels: 1
  out_channels: 1
  dim: 48
  num_blocks: [2, 2, 2]
  spatial_num_blocks: [2,2,2,2]
...
if sigma == 15:
    ...
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/Ablate_DFormerSigma50_2222/models/net_g_latest.pth'
