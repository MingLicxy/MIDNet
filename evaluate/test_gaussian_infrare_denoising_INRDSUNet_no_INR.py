...
#TODO 改动点一
from basicsr.models.archs.DSUNet_arch import DSUNet
...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/INRDSUNet_no_INR', type=str, help='Directory for results')
...
#TODO 改动点三
opt_str = r"""
  type: DSUNet   # 注意：Difformer不是文件名是类名
  inp_channels: 1
  out_channels: 1
  dim: 48
...
if sigma == 15:
    ...
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma50_no_INR/models/net_g_240000.pth'
