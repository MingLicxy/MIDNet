...
#TODO 改动点二
parser.add_argument('--result_dir', default='/home/caoxinyu/UNet-based/Xformer-main/results/INRDSUNet_Laplacian', type=str, help='Directory for results')
...
opt_str = r"""
  ...
  inr_act: 'laplacian'  # 'relu', 'gelu', 'sine', 'expsin', 'gaussian', 'quadratic', 'multi_quadratic', 'laplacian', 'super_gaussian'
...
if sigma == 15:
    #TODO 根据log文件自由选取
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma15_ReLU/models/net_g_296000.pth'
elif sigma == 25:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma25_ReLU/models/net_g_296000.pth'
else:
    weights = '/home/caoxinyu/UNet-based/Xformer-main/experiments/GaussianGrayDenoising_INRDSUNetSigma50_Laplacian/models/net_g_248000.pth'
